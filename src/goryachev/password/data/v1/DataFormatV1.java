...
import goryachev.password.DataFile;
import goryachev.password.DataFormat;
import goryachev.password.DataTools;
import goryachev.password.PassEntry;
import goryachev.password.PassException;
	...
	implements DataFormat
{
	...
	private static final InputStream createInputStream(byte[] key, byte[] iv, InputStream is)
	{
		...
		{
			throw new CException("invalid block size");
		}
