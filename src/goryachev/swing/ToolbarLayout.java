 ...
 *
 * Contributor(s): 
 *   2012-2023 Andy Goryachev <andy@goryachev.com>
 *
 */
		...
		synchronized(parent.getTreeLock())
		{
			...
			for(int i = 0; i < componentCount; i++)
			{
				...
				if(c.isVisible())
				{
					...
					{
						rowh = moveComponents(parent, insets.left + hgap, y, maxWidth - x, rowh, start, i, ltr);
						x = d.width;
						y += vgap + rowh;
						rowh = d.height;
						start = i;
			...
			moveComponents(parent, insets.left + hgap, y, maxWidth - x, rowh, start, componentCount, ltr);
		}
	}
