 ...
 */
package goryachev.common.swing.img.mortennobel;
...
public class DimensionConstraint
{
	 ...
	 */
	public static DimensionConstraint createAbsolutionDimension(final int width, final int height)
	{
	 ...
	 */
	public static DimensionConstraint createRelativeDimension(final float fraction)
	{
	 ...
	 * @return
	 */
	public static DimensionConstraint createRelativeDimension(final float fractionWidth, final float fractionHeight)
	{
	 ...
	 * @return
	 */
	public static DimensionConstraint createMaxDimension(int width, int height)
	{
	 ...
	 * @return
	 */
	public static DimensionConstraint createMaxDimension(final int width, final int height, final boolean neverEnlargeImage)
	{
	 ...
	 * @return
	 */
	public static DimensionConstraint createMaxDimensionNoOrientation(int length1, int length2)
	{
	 ...
	 * @return
	 */
	public static DimensionConstraint createMaxDimensionNoOrientation(final int length1, final int length2, final boolean neverEnlargeImage)
	{
